...
import { entity, Entity, Entities } from '@google-cloud/datastore/build/src/entity';
import { Query, RunQueryCallback, RunQueryOptions, RunQueryResponse } from '@google-cloud/datastore/build/src/query';
import { CommitCallback, CommitResponse, DatastoreRequest, CreateReadStreamOptions, GetResponse, GetCallback, RequestCallback } from '@google-cloud/datastore/build/src/request';
